...
//    class ParseAsyncTask extends AsyncTask<String, Void, ArrayList<Heroes>> {
//
//        @Override
//        protected ArrayList<Heroes> doInBackground(String... strings) {
//            String link = strings[0];
//            ArrayList<Heroes> arrTemp = Heroes.parse(link);
//            listHeroes = arrTemp;
//            return arrTemp;
//        }
//
//        @Override
//        protected void onPostExecute(ArrayList<Heroes> heroes) {
...
//    }
    ...
    public void onClick(Heroes heroes) {
        ...
        String idHeros = heroes.getId();
        Intent intent = new Intent(MainActivity.this, DetailActivity.class);
        intent.putExtra(Constance.ID_HEROES,idHeros);
...
//                String linkHeroes = docName.attr("href");
                ...
                String idHeroe = heroes.get(i).getElementsByTag("span").attr("tag");
                Log.d("tungdt", "id heroes: " + idHeroe);
                ...
                Heroes champ = new Heroes(idHeroe,name, linkHeroes, imageIcon, type, null);
                arrHero.add(champ);
            }
        } catch (Exception e) {
            e.printStackTrace();
